...
#ifndef CY8C4146AZI_S433
    #error "Unexpected target MCU; expected CY8C4146AZI-S433. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
